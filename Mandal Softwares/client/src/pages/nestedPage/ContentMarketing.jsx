...
const ContentMarketing = () => {
  ...
  <BreadcrumbItem isCurrentPage>
    <BreadcrumbLink   transition={'all .3s ease'} _hover={{transform:"scale(1.08)"}}   href='/our-services/content-marketing'>Content Marketing</BreadcrumbLink>
  </BreadcrumbItem>
</Breadcrumb>
...
<Divider  my={2} display={{base:"block", md:"none"}} />
 ...
 <GetQuotePrototype 
 YelloWord="audience" 
main="Attract your audience with original content or creatives" 
sublable="A custom builder that works with your company to provide original creatives, logos, and other resources in an effort to increase audience
"
  />
