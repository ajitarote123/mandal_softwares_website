...
const DigitalMarketing = () => {
  ...
  <BreadcrumbItem isCurrentPage>
    <BreadcrumbLink   transition={'all .3s ease'} _hover={{transform:"scale(1.08)"}}   href='/our-services/digital-marketing'>Digital Marketing  </BreadcrumbLink>
  </BreadcrumbItem>
</Breadcrumb>
...
<Divider  my={2} display={{base:"block", md:"none"}} />
  ...
  {/* planning */ }
        ...
        top={{md:"150px", lg:"160px"}}>
          ...
          <Text  fontSize={{base:"xl", md:"md", lg:"xl"}} >Create</Text>
 ...
 <Stack 
  ...
  _hover={{transform:"scale(1.1)"}} 
        ...
        left={{md:"300px",lg:"400px",xl:"530px" }}  >
          ...
          <Text  fontSize={{base:"xl", md:"md", lg:"xl"}}  >Correction</Text>
...
<Divider my={2}  display={{base:"block", md:"none"}} />
  ...
  data-aos={{base:"zoom-in", md:"fade-down"}}
        ...
        top={{md:"150px", lg:"160px"}} >
          ...
          <Text  fontSize={{base:"xl", md:"md", lg:"xl"}}  >Approval</Text>
...
<Divider  my={2} display={{base:"block", md:"none"}} />
 ...
 _hover={{transform:"scale(1.1)"}} 
        ...
        right={{md:"30px",lg:"50px",xl:"100px" }}
          ...
          <Text  fontSize={{base:"xl", md:"md", lg:"xl"}}  >Delivery</Text>
...
<GetQuotePrototype 
YelloWord="advice" 
main="Get advice from a digital marketing expert to increase business growth" 
sublable="You can find more options in companies that can meet all of your needs by working with a digital marketing specialist for improved business growth." />
