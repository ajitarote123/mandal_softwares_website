import { Box, Breadcrumb, BreadcrumbItem, BreadcrumbLink, Button, Flex, Heading, Highlight, HStack, Image, SimpleGrid, Spacer, Stack, Text, Divider, VStack } from '@chakra-ui/react'
...
const EmailMarketing = () => {
  ...
  <BreadcrumbItem isCurrentPage>
    <BreadcrumbLink   transition={'all .3s ease'} _hover={{transform:"scale(1.08)"}}   href='/our-services/email-marketing'>Email Marketing </BreadcrumbLink>
  </BreadcrumbItem>
</Breadcrumb>
...
<Highlight
 ...
 styles={{ fontsize:"", px: '1', py: '1', color: '#0078ff' }}
  ...
  In addition to your target market, we are aware of the email marketing campaign's objectives (discount, new product introduction, or corporate news). Create your emailer using a smart tool, a new concept, and original content. Provide clients with detailed statistics on the email marketing campaign, including data on open rates, click-through rates, conversions, and other metrics. Track and monitor the email marketing campaign. 
    </Text>
<HStack>
...
maxW={{md:"40%",lg:"50%"}}  >
<Image   w={{md:"100%", lg:"80%"}}  maxH={"550px"} position={"relative"} right="0" src={email} />
</Box>
...
<Divider  my={2} display={{base:"block", md:"none"}} />
  ...
  {/* planning */ }
        ...
        top={{md:"150px", lg:"160px"}}>
          ...
          <Text  fontSize={{base:"xl", md:"md", lg:"xl"}} >Create emailer  </Text>
 ...
 <Stack 
  ...
  _hover={{transform:"scale(1.1)"}} 
        ...
        left={{md:"250px",lg:"300px",xl:"430px" }}  >
          ...
          <Text  fontSize={{base:"xl", md:"md", lg:"xl"}}  >Detailed content  </Text>
...
<Divider my={2}  display={{base:"block", md:"none"}} />
  ...
  data-aos={{base:"zoom-in", md:"fade-down"}}
        ...
        top={{md:"150px", lg:"160px"}} >
          ...
          <Text  fontSize={{base:"xl", md:"md", lg:"xl"}}  >Test </Text>
...
<Divider  my={2} display={{base:"block", md:"none"}} />
 ...
 _hover={{transform:"scale(1.1)"}} 
        ...
        right={{md:"30px",lg:"50px",xl:"100px" }}
          ...
          <Text  fontSize={{base:"xl", md:"md", lg:"xl"}}  >Track & Monitor </Text>
 ...
 <GetQuotePrototype 
YelloWord="Emails" 
main="Increase Your Revenue by Sending More Valuable Emails" 
sublable="A wide variety of email marketing services are available, all tailored to your brand's requirements, financial constraints, and suitable market niches. "
  />
